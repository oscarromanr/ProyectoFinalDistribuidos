 ...
 * @author Fernando
 */
public class frmTablaDatosTemperatura extends javax.swing.JFrame implements iEventListener{
     ...
     */
    public frmTablaDatosTemperatura() {
        initComponents();
    ...
    private void llenarTabla(String temperatura, String idSensor) {
        ...
        while(i < datosTabla.size())
        {
            ...
            {
                datosTabla.get(i).add(temperatura);
                filaExiste = true;
            }
            i++;
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmTablaDatosTemperatura.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmTablaDatosTemperatura().setVisible(true);
            }
        });
    }
    ...
    public void update(String mensaje) {
        ...
        llenarTabla(temperatura, idSensor);
    }
}
